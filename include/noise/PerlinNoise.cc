...
/** \file
		\brief Implements the PerlinNoise1234 class for producing Perlin noise.
		\author Stefan Gustavson (stegu@itn.liu.se)
*/
 ...
 */
unsigned char PerlinNoise::perm[] = {151,160,137,91,90,15,
 ...
 * float SLnoise = (PerlinNoise1234::noise(x,y,z) + 1.0) * 0.5;
 */
...
float  PerlinNoise::grad( int hash, float x, float y, float z, float t ) {
 ...
 */
float PerlinNoise::pnoise( float x, int px )
{
    int ix0, ix1;
    float fx0, fx1;
    float s, n0, n1;
 ...
 */
float PerlinNoise::pnoise( float x, float y, int px, int py )
{
    int ix0, iy0, ix1, iy1;
    float fx0, fy0, fx1, fy1;
    float s, t, nx0, nx1, n0, n1;
 ...
 */
float PerlinNoise::pnoise( float x, float y, float z, int px, int py, int pz )
{
    int ix0, iy0, ix1, iy1, iz0, iz1;
    float fx0, fy0, fz0, fx1, fy1, fz1;
    float s, t, r;
...
float PerlinNoise::noise( float x, float y, float z, float w )
{
...
float PerlinNoise::pnoise( float x, float y, float z, float w,
